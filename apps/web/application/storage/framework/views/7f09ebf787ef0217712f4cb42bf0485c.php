        ...
        <div class="modal-content hidden" id="cardModalContent">
            ...
            <form id="convertLeadForm">
                <div class="modal-body row hidden min-h-200 overlay" id="leadConvertToCustomer">
                    ...
                    <?php echo $__env->make('pages.lead.convert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
<!--js dom elements-->
<?php echo $__env->make('pages.lead.components.js-elements', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<script src="public/js/core/card.js?v=<?php echo e(config('system.versioning')); ?>"></script><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/pages/lead/modal.blade.php ENDPATH**/ ?>