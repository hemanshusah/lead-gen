...
<aside class="left-sidebar" id="js-trigger-nav-team">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
               ...
               <!--projects-->
                ...
                <!--leadgen-->
                <li data-modular-id="main_menu_team_leadgen"
                    class="sidenav-menu-item <?php echo e($page['mainmenu_leadgen'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    title="LeadGen">
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>