            ...
            <div class="x-title">
                ...
                <span><?php echo e(runtimeLang($event->event_item_lang_alt)); ?> <?php echo e($event->event_item_content3); ?><span>
                        ...
                        <span><?php echo e(runtimeLang($event->event_item_lang)); ?><span>
                                ...
                                <!--do nothing-->
                                <?php else: ?>
                                <?php echo $__env->make('pages.events.includes.parent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php endif; ?>
            </div>
            <?php if($event->event_show_item == 'yes'): ?>
            <?php echo $__env->make('pages.events.includes.content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
<!--each events item-->
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/pages/timeline/components/misc/ajax.blade.php ENDPATH**/ ?>