<div class="board">
    <div class="board-body <?php echo e(runtimeKanbanBoardColors($board['color'])); ?>">
        ...
        <div class="content kanban-content" id="kanban-board-wrapper-<?php echo e($board['id']); ?>" data-board-name="<?php echo e($board['id']); ?>">
            ...
            <?php echo $__env->make('pages.leads.components.kanban.card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>

            <!-- dynamic load more button-->
            <?php echo $__env->make('pages.leads.components.kanban.loadmore-button', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/pages/leads/components/kanban/board.blade.php ENDPATH**/ ?>