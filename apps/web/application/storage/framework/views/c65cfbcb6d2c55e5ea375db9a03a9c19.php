                ...
                <li class="nav-item dropdown hidden-xs-down my-timer-container <?php echo e(runtimeVisibility('topnav-timer', request('show_users_running_timer'))); ?>"
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                        <div class="active-timer-topnav" id="active-timer-topnav-container">
                            ...
                            <?php echo $__env->make('misc.timer-topnav-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php else: ?>
...
</header><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>