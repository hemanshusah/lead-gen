...
<tr id="lead_<?php echo e($lead->lead_id); ?>" class=" <?php echo e($lead->pinned_status ?? ''); ?>">
    ...
    <td class="leads_col_assigned <?php echo e(config('table.tableconfig_column_6')); ?> tableconfig_column_6"
        ...
        <?php echo $__env->make('misc.more-users', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
        <!--more users-->
    </td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>