    ...
    <div class="kanban-card-content-comntainer">
        ...
        <div class="x-meta">
            ...
            <div class="wrap-words" id="reminder_card_view_container_<?php echo e($lead->lead_id ?? ''); ?>">
                ...
                <?php echo $__env->make('pages.reminders.cards.kanban', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Users/arochan/Desktop/personal/lead-gen/apps/web/application/resources/views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>