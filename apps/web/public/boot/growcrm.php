...
if (version_compare(PHP_VERSION, '8.2', ">=")) {
    ...
    $messages_php .= '
        ...
        <br/><br/>
        You can easily set/change the required <strong>PHP Version</strong> inside your web hosting control panel. <a href="https://mycrm.io/documentation/setting-your-php-version/" target="_blank">(see decumentation for help)</a>
        </div></td></tr>';
    $errors++;
}
...
<h5>System Check</h5><div><img src="public/images/system-checks.png" width="300" alt="system checks failed" /></div><p class="card-text">The following (minimum system requirements) must be met before you can continue. See <a href="https://mycrm.io/documentation/2-installation/" target="_blank">documentation</a> for details.</p>
