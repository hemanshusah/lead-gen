...
class Kernel extends HttpKernel {
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            //[mycrm] make sure we have no session during setup
    ...
    protected $routeMiddleware = [
        ...
        //[mycrm] - [documents](proposals & contracts)
