        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form hidden"
                    ...
                    data-url="http://mycrm.co.zw/subscription/20/update-card" data-loading-target="commonModalBody"
                    data-modal-title="Update Credit Card"
                    data-action-url="http://mycrm.co.zw/subscription/20/update-card?ref=list" data-action-method="PUT"
